...
function loadDoctorData() {
    doctorId = window.location.hash.substring(1);
    if(doctorId === "new") {
        loadNewId();
        return;
    }
    fetch("http://localhost:3000/doctor/" + doctorId,{
        ...
        response.json().then(data => ({
            ...
            if(result !== null) {
                ...
                homeTown.value = result.QueQuan;
                address.value = result.DiaChi;
                departmentFilter.value = result.MaKhoa;
            }else if(res.data.error !== null) {
                window.scrollTo(0, 0);
                $errorNotification.find("#error-message")
                    .text("Lấy chi tiết bác sĩ thất bại, vui lòng thử lại sau");
                $errorNotification.fadeIn(500, "swing", function() {
                    setTimeout(function() {
                        $errorNotification.fadeOut(2000, "linear");
                    }, 2500);
...
function loadNewId() {
    fetch("http://localhost:3000/doctor/create/newId",{
        method:"GET",
        headers: {
            "Content-Type": "application/json"
        },
        ...
        response.json().then(data => ({
            ...
            if(result !== null) {
                ...
                window.scrollTo(0, 0);
                $errorNotification.find("#error-message")
                    .text("Tạo mã bác sĩ mới thất bại, vui lòng thử lại sau");
                $errorNotification.fadeIn(500, "swing", function() {
                    setTimeout(function() {
                        $errorNotification.fadeOut(2000, "linear");
                    }, 2500);
...
function checkDuplicateIdentity() {
    fetch("http://localhost:3000/doctor/checkDuplicate/identity",{
        method:"POST",
        headers: {
            "Content-Type": "application/json"
        },
...
function checkDuplicatePhoneNumber() {
    fetch("http://localhost:3000/doctor/checkDuplicate/phoneNumber",{
        method:"POST",
        headers: {
            "Content-Type": "application/json"
        },
...
function checkDuplicateEmail() {
    fetch("http://localhost:3000/doctor/checkDuplicate/email",{
        method:"POST",
        headers: {
            "Content-Type": "application/json"
        },
...
function checkDoctorData() {
    if(surname.value === "") {
        ...
        let alert = document.getElementById("home-town-alert");
        alert.style.display = "block";
        return;
    }
    if(doctorId === "new") {
...
function clearAllNotifications() {
    ...
    document.getElementById("home-town-alert").style.display = "none";
}
    ...
    fetch("http://localhost:3000/doctor",{
        ...
        response.json().then(data => ({
            ...
            if(res.data.status === "201") {
                window.location.href = "../../html/admin/doctor.html#success";
            }else if(res.data.status === "500") {
                window.scrollTo(0, 0);
                $errorNotification.find("#error-message")
                    .text("Thêm bác sĩ thất bại, vui lòng thử lại sau");
                $errorNotification.fadeIn(500, "swing", function() {
                    setTimeout(function() {
                        $errorNotification.fadeOut(2000, "linear");
                    }, 2500);
    ...
    fetch("http://localhost:3000/doctor",{
        ...
        response.json().then(data => ({
            ...
            if(res.data.status === "200") {
                ...
                window.scrollTo(0, 0);
                $errorNotification.find("#error-message")
                    .text("Cập nhật bác sĩ thất bại, vui lòng thử lại sau");
                $errorNotification.fadeIn(500, "swing", function() {
                    setTimeout(function() {
                        $errorNotification.fadeOut(2000, "linear");
                    }, 2500);
